...
let project = Project(
    ...
    targets: [
        ...
        Target(
            ...
            bundleId: "io.geko.App.StickersPackExtension",
        ...
        Target(
            ...
            bundleId: "io.geko.App2.MessageExtension",
            infoPlist: .extendingDefault(with: [
                "CFBundleDisplayName": "$(PRODUCT_NAME)",
                "NSExtension": [
        ...
        Target(
            ...
            destinations: .iOS,
            product: .appExtension,
            bundleId: "io.geko.App.WidgetExtension",
            infoPlist: .extendingDefault(with: [
                "CFBundleDisplayName": "$(PRODUCT_NAME)",
                "NSExtension": [
        ...
        Target(
            ...
            bundleId: "io.geko.App.AppIntentExtension",
            infoPlist: .extendingDefault(with: [
