import UIKit
import HelloFromCCustomModuleMap
import HelloFromCCode
import HelloFromCCodeUmbrellaDir
import HelloFromCCodeNestedUmbrella
import ObjcSpm
...
extension Styles {
    ...
    public static func helloFromStyles() {
        print("Hello from style")
        sayHelloFromCWithCustomModuleMap()
        sayHelloFromCCode()
        sayHelloFromCCodeUmbrellaDir()
        sayHelloFromCCodeNestedUmbrella()
        ObjcSpmLogger().logMessage()
    }
}
