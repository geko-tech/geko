...
public protocol TerminalDelegate: AnyObject {
     ...
     */
    func setForegroundColor (source: Terminal, color: SwiftTermColor)
    
    /**
     * The view should try to set the background color to the provided color
     */
    func setBackgroundColor (source: Terminal, color: SwiftTermColor)
    
    /**
     * The view should try to set the cursor color to the provided color.   If color is nil, the view can use a default.
     */
    func setCursorColor (source: Terminal, color: SwiftTermColor?)
    
    /**
     * This should return the current foreground and background colors to
     * report.
     */
    func getColors (source: Terminal) -> (foreground: SwiftTermColor, background: SwiftTermColor)
...
open class Terminal {
    ...
    public var foregroundColor: SwiftTermColor = SwiftTermColor.defaultForeground {
        didSet {
            if settingFgColor {
                return
            }
    ...
    public var backgroundColor: SwiftTermColor = SwiftTermColor.defaultBackground {
        didSet {
            if settingBgColor {
                return
            }
    ...
    public var cursorColor: SwiftTermColor? = nil {
        didSet {
    ...
    {
        installedColors = SwiftTermColor.defaultInstalledColors
        defaultAnsiColors = SwiftTermColor.setupDefaultAnsiColors (initialColors: installedColors)
    ...
    public func installPalette (colors: [SwiftTermColor])
    {
        if colors.count != 16 {
            return
        }
    ...
    func oscChangeOrQueryColorIndex (_ data: ArraySlice<UInt8>)
    {
        ...
        while parsePos <= data.endIndex {
            ...
            if let newColor = SwiftTermColor.parseColor (data [parsePos..<end]) {
    ...
    func reportColor (oscCode: Int, color: SwiftTermColor) {
    ...
    func oscSetColors (_ data: ArraySlice<UInt8>, startAt: Int)
    {
        ...
        while next < groups.count {
            ...
            guard let color = SwiftTermColor.parseColor(text) else {
                continue
            }
            switch next {
            case 0:
    ...
    func oscSetTextBackground (_ data: ArraySlice<UInt8>)
    {
        ...
        if let background = SwiftTermColor.parseColor(data) {
    ...
    {
        if let cursorColor = SwiftTermColor.parseColor(data) {
