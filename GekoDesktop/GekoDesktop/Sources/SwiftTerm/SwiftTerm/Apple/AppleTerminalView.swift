...
extension TerminalView {
    ...
    func setupOptions(width: CGFloat, height: CGFloat)
    {
        ...
        terminal.backgroundColor = SwiftTermColor.defaultBackground
        terminal.foregroundColor = SwiftTermColor.defaultForeground
    ...
    public func installColors (_ colors: [SwiftTermColor])
    {
    ...
    public func setBackgroundColor(source: Terminal, color: SwiftTermColor) {
        // Can not implement this until I change the color to not be this struct
        nativeBackgroundColor = TTColor.make (color: color)
        colorsChanged()
    }
    
    public func setForegroundColor(source: Terminal, color: SwiftTermColor) {
    ...
    public func setCursorColor(source: Terminal, color: SwiftTermColor?, textColor: SwiftTermColor?) {
