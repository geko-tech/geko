...
![inspector](/resources/desktop/settings/desktop_conf_conf.png)

![inspector](/resources/desktop/settings/desktop_conf_edit.png)
...
![inspector](/resources/desktop/settings/desktop_conf_profile.png)
...
![inspector](/resources/desktop/settings/desktop_conf_scheme.png)

## Options

Geko options. Also you can add/edit/remove castom options. [Learn about default geko options](../cache/cache_usage)

![inspector](/resources/desktop/settings/desktop_conf_options.png)

![inspector](/resources/desktop/settings/desktop_conf_options_edit.png)

## Destination

Destination device or simulator

![inspector](/resources/desktop/settings/desktop_conf_target.png)
...
![inspector](/resources/desktop/settings/desktop_conf_focus_edit.png)

![inspector](/resources/desktop/settings/desktop_conf_focus_empty.png)

## Final build command

The final command that is called in the console. Can be copied to the clipboard.

![inspector](/resources/desktop/settings/desktop_conf_command.png)