...
final class StableXcodeProjIntegrationTests: GekoTestCase {
    func testXcodeProjStructureDoesNotChangeAfterRegeneration() throws {
        ...
        for _ in 0 ..< 10 {
            ...
            let (workspaceDescriptor, _) = try subject.generateWorkspace(graphTraverser: graphTraverser, sideTable: GraphSideTable())
