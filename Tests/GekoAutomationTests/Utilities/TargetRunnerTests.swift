...
final class TargetRunnerTests: GekoUnitTestCase {
    ...
    func test_throwsError_when_buildProductNotFound() async throws {
        ...
        xcodeProjectBuildDirectoryLocator.locateStub = { _, _, _, _, _ in outputPath }
    ...
    func test_usesDefaultConfiguration_when_noConfiguration() async throws {
        ...
        xcodeProjectBuildDirectoryLocator.locateStub = { _, _, _, _configuration, _ in
            // THEN
    ...
    func test_runsApp_when_platform_is_iOS_and_product_is_app() async throws {
        ...
        let bundleId = "com.geko.bundleid"
