...
final class InfoPlistContentProviderTests: XCTestCase {
    ...
    func test_content_whenWatchOSApp() {
        ...
        assertEqual(got, [
            ...
            "WKWatchKitApp": true,
            "WKCompanionAppBundleIdentifier": "io.geko.my.app.id",
            "ExtraAttribute": "Value",
    ...
    func test_content_whenWatchOSAppExtension() {
        ...
        let watchApp = Target.test(
            destinations: .watchOS,
            product: .watch2App,
            bundleId: "io.geko.my.app.id.mywatchapp",
            dependencies: [
        ...
        assertEqual(got, [
            ...
            "NSExtension": [
                "NSExtensionAttributes": [
                    "WKAppBundleIdentifier": "io.geko.my.app.id.mywatchapp",
                ],
