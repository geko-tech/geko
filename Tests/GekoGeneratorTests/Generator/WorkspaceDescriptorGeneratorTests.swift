...
final class WorkspaceDescriptorGeneratorTests: GekoUnitTestCase {
    ...
    override func setUp() {
        ...
        subject = WorkspaceDescriptorGenerator(
            ...
            config: .init(projectGenerationContext: .serial)
        )
    }
    ...
    func test_generate_workspaceStructure_noWorkspaceData() throws {
        ...
        // When
        XCTAssertNoThrow(
            try subject.generate(graphTraverser: graphTraverser, sideTable: GraphSideTable())
        )
    }
