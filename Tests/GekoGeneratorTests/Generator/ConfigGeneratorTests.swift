...
final class ConfigGeneratorTests: GekoUnitTestCase {
    var pbxproj: PBXProj!
    ...
    func test_generateTargetConfig_whenSourceRootIsEqualToXcodeprojPath() throws {
        ...
        try subject.generateTargetConfig(
            ...
            fileElements: ProjectFileElements(enforceExplicitDependencies: false),
    ...
    private func generateTestTargetConfig(
        ...
        _ = try subject.generateTargetConfig(
            ...
            pbxproj: pbxproj,
            projectSettings: project.settings,
            fileElements: .init(enforceExplicitDependencies: false),
            graphTraverser: graphTraverser,
            sourceRootPath: dir
        )
    }
