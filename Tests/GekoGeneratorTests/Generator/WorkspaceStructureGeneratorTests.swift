...
final class WorkspaceStructureGeneratorTests: XCTestCase {
    ...
    func test_generateStructure_addsDependenciesToADependenciesGroup() throws {
        // Given
        let xcodeProjPaths = try createFolders([
            "/path/to/workspace/Geko/Dependencies/SwiftPackageManager/.build/geko-derived/AEXML/AEXML.xcodeproj",
            "/path/to/workspace/Geko/Dependencies/SwiftPackageManager/.build/geko-derived/SwiftSyntax/SwiftSyntax.xcodeproj",
        ])
        ...
        XCTAssertEqual(structure.contents, [
            .virtualGroup(name: "Dependencies", contents: [
                .project("/path/to/workspace/Geko/Dependencies/SwiftPackageManager/.build/geko-derived/AEXML/AEXML.xcodeproj"),
                .project(
                    "/path/to/workspace/Geko/Dependencies/SwiftPackageManager/.build/geko-derived/SwiftSyntax/SwiftSyntax.xcodeproj"
                ),
            ]),
    ...
    fileprivate class InMemoryFileHandler: FileHandling {
        ...
        func glob(_ paths: [AbsolutePath], excluding: [AbsolutePath]) throws -> [AbsolutePath] {
            []
        }
        ...
        func createSymbolicLink(at path: ProjectDescription.AbsolutePath, destination: ProjectDescription.AbsolutePath) throws {
        }
        ...
        func writePlistFile<T>(_ content: T, path: AbsolutePath) throws where T : Encodable {
            // Do nothing
        }
