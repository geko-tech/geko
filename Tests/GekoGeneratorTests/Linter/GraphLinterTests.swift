...
final class GraphLinterTests: GekoUnitTestCase {
    ...
    func test_lintDifferentBundleIdentifiers() {
        ...
        let path: AbsolutePath = "/project"
        let appTarget = Target.test(name: "AppTarget", product: .app)
        let frameworkA = Target.test(name: "frameworkA", product: .framework, bundleId: "com.geko.frameworks.test")
        let frameworkB = Target.test(name: "frameworkB", product: .framework, bundleId: "com.geko.frameworks.test2")
