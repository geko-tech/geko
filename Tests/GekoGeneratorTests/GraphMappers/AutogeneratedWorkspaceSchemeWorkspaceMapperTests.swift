...
final class AutogeneratedWorkspaceSchemeWorkspaceMapperTests: GekoUnitTestCase {
    func test_map() throws {
        ...
        // When
        var got = WorkspaceWithProjects(workspace: workspace, projects: [project, projectB])
    ...
    func test_multiple_project_sorting() throws {
        ...
        // When
        var got = WorkspaceWithProjects(workspace: workspace, projects: [projectB, projectA])
        var sideTable = WorkspaceSideTable()
        _ = try subject.map(
            workspace: &got,
            sideTable: &sideTable
    ...
    func test_map_codeCoverage_disabled() throws {
        ...
        // When
        var got = WorkspaceWithProjects(workspace: workspace, projects: [project])
        var sideTable = WorkspaceSideTable()
        _ = try subject.map(
            workspace: &got,
            sideTable: &sideTable
    ...
    func test_map_codeCoverageMode_relevant_complex() throws {
        ...
        // When
        var got = WorkspaceWithProjects(workspace: workspace, projects: [projectSingleCoverage, projectAllCoverage])
        var sideTable = WorkspaceSideTable()
        _ = try subject.map(
            workspace: &got,
            sideTable: &sideTable
