...
final class CopyFilesActionsContentHasherTests: GekoUnitTestCase {
    ...
    func test_hash_copyFilesAction_callsMockHasherWithExpectedStrings() throws {
        ...
        // Then
        let expected = [file1Hash, file2Hash, "Copy Fonts", "resources", "Fonts"].sorted()
    ...
    func test_hash__copyFilesAction_valuesAreNotHarcoded() throws {
        ...
        // Then
        let expected = [file1Hash, "Copy Templates", "sharedSupport", "Templates"].sorted()
