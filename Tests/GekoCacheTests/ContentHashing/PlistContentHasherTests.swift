...
final class InfoPlistContentHasherTests: GekoUnitTestCase {
    ...
    func test_hash_whenPlistIsDictionary_allDictionaryValuesAreConsideredForHash() throws {
        ...
        XCTAssertEqual(
            hash,
            "1=integer(23);2=string(\"foo\");3=boolean(true);4=boolean(false);5=array([ProjectDescription.Plist.Value.string(\"5a\"), ProjectDescription.Plist.Value.string(\"5b\")]);6=dictionary([\"6a\": ProjectDescription.Plist.Value.string(\"6value\")]);-hash"
        )
    }
