...
final class ImportSourceCodeScannerTests: GekoUnitTestCase {
    ...
    func test_whenSwiftWithTypeImports() throws {
        ...
        import typealias ModuleE.SomeTypealias
        ...
        // Then
        XCTAssertEqual(imports, ["ModuleA", "ModuleB", "ModuleC", "ModuleD", "ModuleE"])
    }
