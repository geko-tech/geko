...
public final class TargetRunner: TargetRunning {
    ...
    private func runApp(
        ...
        guard let bundleId else {
            // Due to optional bundle id this funcionality is partially broken
            fatalError("To be able to run app from simulator you must setup bundle id for target \(target.target.name)")
        }
