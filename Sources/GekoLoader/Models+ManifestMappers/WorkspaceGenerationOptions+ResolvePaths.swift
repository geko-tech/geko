...
extension GekoGraph.Workspace.GenerationOptions {
...
extension GekoGraph.Workspace.GenerationOptions.AutogeneratedWorkspaceSchemes {
    mutating func resolvePaths(generatorPaths: GeneratorPaths) throws {
        switch self {
        case .disabled:
            break
        case var .enabled(codeCoverageMode, testingOptions, testLanguage, testRegion, testScreenCaptureFormat):
...
extension GekoGraph.Workspace.GenerationOptions.AutogeneratedWorkspaceSchemes.CodeCoverageMode {
    mutating func resolvePaths(generatorPaths: GeneratorPaths) throws {
        switch self {
        case .all:
            break
...
extension GekoGraph.Workspace.GenerationOptions.AutogenerateLocalPodsProjects {
    mutating func resolvePaths(generatorPaths: GeneratorPaths) throws {
        switch self {
        case .disabled: 
            break
...
extension GekoGraph.Workspace.GenerationOptions.AutogenerateLocalPodsSchemes {
    mutating func resolvePaths(generatorPaths: GeneratorPaths) throws {
