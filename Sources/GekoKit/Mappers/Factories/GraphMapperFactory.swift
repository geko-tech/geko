...
public final class GraphMapperFactory: GraphMapperFactorying {
    ...
    public func `default`(
        ...
        mappers.append(FocusTargetsGraphMappers())
        mappers.append(TreeShakePrunedTargetsGraphMapper())
        mappers.append(AutogeneratedSchemesWorkspaceGraphMapper())
        mappers.append(AutogeneratedSchemesProjectsGraphMapper())
        mappers.append(AutogeneratedTestPlansGraphMapper())
