...
public class TrackableCommand: TrackableParametersDelegate {
    ...
    private let store: GekoAnalyticsStoreHandling
    ...
    public init(
        ...
        store: GekoAnalyticsStoreHandling = GekoAnalyticsStoreHandler()
    ) {
    ...
    public func run() async throws {
        ...
        do {
            ...
            try trackCommand(timer: timer, isError: false)
        } catch {
            try trackCommand(timer: timer, isError: true)
            throw error
        }
    }
    ...
    private func trackCommand(timer: ClockTimer, isError: Bool) throws {
        ...
        try store.store(command: commandEvent)
    }
