...
extension Workspace {
    ...
    public func codeCoverageTargets(projects: [Project]) -> [TargetReference] {
        ...
        case .relevant: return relevantTargets(projects: projects)
        }
    }
    ...
    private func relevantTargets(projects: [Project]) -> [TargetReference] {
...
extension Workspace {
    public var autogeneratedSchemeWorkspaces: [AutogeneratedSchemes.AutogeneratedSchemeWorkspace] {
        generationOptions.autogeneratedSchemes.compactMap {
            switch $0 {
            case let .workspace(autogeneratedSchemeWorkspace): autogeneratedSchemeWorkspace
            default: nil
            }
        }
    }

    public var allProjectsAutogeneratedSchemes: [AutogeneratedSchemes.AutogeneratedSchemeProject] {
        generationOptions.autogeneratedSchemes.compactMap {
            switch $0 {
            case let .allProjects(autogeneratedSchemeProject): autogeneratedSchemeProject
            default: nil
            }
        }
    }

    public var customProjectsAutogeneratedSchemes: [(projectName: String, autogeneratedSchemeProject: AutogeneratedSchemes.AutogeneratedSchemeProject)] {
        generationOptions.autogeneratedSchemes.compactMap {
            switch $0 {
            case let .project(projectName, autogeneratedSchemeProject): (projectName: projectName, autogeneratedSchemeProject: autogeneratedSchemeProject)
            default: nil
            }
        }
    }
