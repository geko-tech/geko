...
extension PackageInfo {
          ...
          "dependencies" : [
            {
              ...
              "url" : "https://github.com/geko/a-dependency"
            },
            {
              ...
              "url" : "https://github.com/geko/another-dependency"
            }
          ],
          "name" : "geko",
          "packageKind" : "root",
    ...
    public static var test: PackageInfo {
        .init(
            name: "geko",
            products: [
                .init(name: "Geko", type: .library(.static), targets: ["Geko"]),
            ],
            targets: [
                .init(
                    name: "Geko",
                    ...
                    dependencies: [
                        .target(name: "GekoKit", condition: nil),
                        .product(
                            name: "ALibrary",
                ...
                .init(
                    ...
                    exclude: [],
                    dependencies: [
                        .byName(name: "GekoKit", condition: nil),
