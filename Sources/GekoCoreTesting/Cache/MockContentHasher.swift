...
public final class MockContentHasher: ContentHashing {
    ...
    public var stubHashForPathWithExclude: [AbsolutePath: String] = [:]
    public var hashPathWithExcludeCallCount = 0
    public func hash(path filePath: AbsolutePath, exclude: [(AbsolutePath) -> Bool]) throws -> String {
        hashPathWithExcludeCallCount += 1
        return stubHashForPathWithExclude[filePath] ?? ""
    }
