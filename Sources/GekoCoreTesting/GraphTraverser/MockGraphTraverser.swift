...
final class MockGraphTraverser: GraphTraversing {
    ...
    var invokedAllTargetDependenciesResult: Set<GekoGraph.GraphTarget> = []
    func allTargetDependencies(path: AbsolutePath, name: String) -> Set<GekoGraph.GraphTarget> {
    ...
    var invokedClosestTargetDependencies = false
    var invokedClosestTargetDependenciesCount = 0
    var invokedClosestTargetDependenciesParameters: (path: AbsolutePath, name: String)?
    var invokedClosestTargetDependenciesParametersList =
        [(path: AbsolutePath, name: String)]()
    var stubbedClosestTargetDependenciesResult: Set<GraphTargetReference>! = []

    func closestTargetDependencies(path: AbsolutePath, name: String) -> Set<GraphTargetReference> {
        invokedClosestTargetDependencies = true
        invokedClosestTargetDependenciesCount += 1
        invokedClosestTargetDependenciesParameters = (path, name)
        invokedClosestTargetDependenciesParametersList.append((path, name))
        return stubbedClosestTargetDependenciesResult
    }
    ...
    var invokedStaticXCFrameworkDependencies = false
    var invokedStaticXCFrameworkDependenciesCount = 0
    var invokedStaticXCFrameworkDependenciesParameters: (path: AbsolutePath, name: String)?
    var invokedStaticXCFrameworkDependenciesParametersList =
        [(path: AbsolutePath, name: String)]()
    var stubbedStaticXCFrameworkDependenciesResult: Set<GraphDependencyReference>! = []

    func staticXCFrameworkDependencies(path: AbsolutePath, name: String) -> Set<GekoCore.GraphDependencyReference> {
        invokedStaticXCFrameworkDependencies = true
        invokedStaticXCFrameworkDependenciesCount += 1
        invokedStaticXCFrameworkDependenciesParameters = (path, name)
        invokedStaticXCFrameworkDependenciesParametersList.append((path, name))
        return stubbedStaticXCFrameworkDependenciesResult
    }
    ...
    func extensionKitExtensionDependenciesWithConditions(
        path: AbsolutePath, name: String
    ) -> [(
    ...
    func directSwiftMacroExecutables(path: AbsolutePath, name: String) -> Set<GekoCore.GraphDependencyReference> {
    ...
    func allSwiftMacroTargets(path: AbsolutePath, name: String) -> Set<GekoGraph.GraphTarget> {
    ...
    var invokedAllUnusedDependencies = false
    var invokedAllUnusedDependenciesCount = 0
    var stubbedAllUnusedDependenciesResult: Set<TargetDependency>! = []
    func allUnusedDependencies() -> Set<TargetDependency> {
        invokedAllUnusedDependencies = true
        invokedAllUnusedDependenciesCount += 1
        return stubbedAllUnusedDependenciesResult
    }
