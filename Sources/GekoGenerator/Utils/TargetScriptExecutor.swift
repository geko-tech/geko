...
public final class TargetScriptExecutor: TargetScriptExecuting {
    ...
    private let scriptEnvs: [String: [String]]
    ...
    public func execute(graph: GekoGraph.Graph) async throws {
        ...
        let targets = filterTargetsWithBuildPhaseScripts(graphTraverser: graphTraverser)
    ...
    func filterTargetsWithBuildPhaseScripts(graphTraverser: GraphTraversing) -> [TargetWithScripts] {
