...
public final class DescriptorGenerator: DescriptorGenerating {
    ...
    public convenience init(
        ...
        let autogeneratedXCTestPlanDescriptorGenerator = AutogeneratedXCTestPlanDescriptorGenerator()
    ...
    public func generateWorkspace(graphTraverser: GraphTraversing, sideTable: GraphSideTable) throws -> (WorkspaceDescriptor, [SideEffectDescriptor]) {
