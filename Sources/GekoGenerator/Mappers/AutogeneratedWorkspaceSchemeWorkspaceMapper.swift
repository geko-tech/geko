...
public final class AutogeneratedWorkspaceSchemeWorkspaceMapper: WorkspaceMapping { // swiftlint:disable:this type_name
    ...
    public func map(
        ...
        guard
            workspace.workspace.autogeneratedSchemeWorkspaces.isEmpty,
            workspace.workspace.generationOptions.autogeneratedWorkspaceSchemes != .disabled || forceWorkspaceSchemes,
