...
public struct WorkspaceDescriptor {
    ...
    /// The descriptors are used to generate `.xctestplan`.
    public var autogeneratedXCTestPlanDescriptors: [AutogeneratedXCTestPlanDescriptor]
    ...
    public init(
        ...
        autogeneratedXCTestPlanDescriptors: [AutogeneratedXCTestPlanDescriptor],
        ...
        self.autogeneratedXCTestPlanDescriptors = autogeneratedXCTestPlanDescriptors
